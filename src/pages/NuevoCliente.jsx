...
export async function action({request}){
    const formData = await request.formData() //almacenar los datos escritos en el form
...
function NuevoCliente() {
    ...
    return (
        <>
            ...
            <p className='mt-3'>Completá el formulario para agregar un nuevo <span className='text-blue-900 font-bold'>Cliente</span></p>
